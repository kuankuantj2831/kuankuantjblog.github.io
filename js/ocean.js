(function ($) {
  ...
  $(document).ready(function() {
    ...
    var $btn = $('#add-post-btn');
    var $span = $('.close-button');

    // Ensure the elements exist before adding event handlers
    if ($btn.length && $modal.length && $span.length) {
      ...
      $(window).on('click', function(event) {
        // Hide modal if user clicks on the background
