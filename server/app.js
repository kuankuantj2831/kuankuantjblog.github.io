...
const gameCenterRoutes = require('./routes/game-center'); // 游戏化中心
const gameCenterV2Routes = require('./routes/game-center-v2'); // 游戏化中心V2
const gameCenterV3Routes = require('./routes/game-center-v3'); // 游戏化中心V3
const gameCenterV4Routes = require('./routes/game-center-v4'); // 游戏化中心V4
const gameCenterV5Routes = require('./routes/game-center-v5'); // 游戏化中心V5
...
app.use('/game-center', gameCenterRoutes); // 游戏化中心 - 宠物、成就、抽奖、PK、猜谜、兑换码
app.use('/game-center', gameCenterV2Routes); // 游戏化中心V2 - 聊天室、部落、论坛、装扮、活动、股市、小游戏
app.use('/game-center', gameCenterV3Routes); // 游戏化中心V3 - 钓鱼、农场、宠物对战、婚姻、师徒、刮刮乐、骰子、幸运数字、冒险、运势
app.use('/game-center', gameCenterV4Routes); // 游戏化中心V4 - 社交互动+经济系统+收藏养成
app.use('/game-center', gameCenterV5Routes); // 游戏化中心V5 - 竞技游戏+社区生活
