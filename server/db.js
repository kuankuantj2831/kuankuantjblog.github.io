...
async function initDB() {
    ...
    try {
        ...
        // ===== 游戏化中心V4+V5表 =====
        await connection.query(`CREATE TABLE IF NOT EXISTS game_friends (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, friend_id INT NOT NULL, status ENUM('pending','accepted','blocked') DEFAULT 'pending', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, FOREIGN KEY (friend_id) REFERENCES users(id) ON DELETE CASCADE, UNIQUE KEY unique_friend (user_id, friend_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_signature_wall (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, message VARCHAR(200) NOT NULL, mood VARCHAR(10) DEFAULT '😊', likes INT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_anonymous_letters (id INT AUTO_INCREMENT PRIMARY KEY, from_user_id INT NOT NULL, to_user_id INT NOT NULL, content TEXT NOT NULL, letter_type VARCHAR(10) DEFAULT '💌', is_read BOOLEAN DEFAULT FALSE, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (from_user_id) REFERENCES users(id) ON DELETE CASCADE, FOREIGN KEY (to_user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_polls (id INT AUTO_INCREMENT PRIMARY KEY, creator_id INT NOT NULL, title VARCHAR(200) NOT NULL, is_active BOOLEAN DEFAULT TRUE, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (creator_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_poll_options (id INT AUTO_INCREMENT PRIMARY KEY, poll_id INT NOT NULL, text VARCHAR(100) NOT NULL, FOREIGN KEY (poll_id) REFERENCES game_polls(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_poll_votes (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, option_id INT NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, FOREIGN KEY (option_id) REFERENCES game_poll_options(id) ON DELETE CASCADE, UNIQUE KEY unique_vote (user_id, option_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_wishes (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, content VARCHAR(200) NOT NULL, blessings INT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_wish_blesses (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, wish_id INT NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, FOREIGN KEY (wish_id) REFERENCES game_wishes(id) ON DELETE CASCADE, UNIQUE KEY unique_bless (user_id, wish_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_mood_diary (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, mood VARCHAR(20) NOT NULL, content TEXT, tags VARCHAR(100), created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, UNIQUE KEY unique_user_date (user_id, DATE(created_at))) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_checkin_wall (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, checkin_date DATE NOT NULL, streak INT DEFAULT 1, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, UNIQUE KEY unique_user_checkin (user_id, checkin_date)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_fanclub (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, target_id INT NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, FOREIGN KEY (target_id) REFERENCES users(id) ON DELETE CASCADE, UNIQUE KEY unique_fan (user_id, target_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_custom_emojis (id INT AUTO_INCREMENT PRIMARY KEY, creator_id INT NOT NULL, name VARCHAR(30) NOT NULL, emoji VARCHAR(20) NOT NULL, category VARCHAR(30) DEFAULT 'fun', likes INT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (creator_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_bank (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL UNIQUE, savings INT DEFAULT 0, loan INT DEFAULT 0, last_interest TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_auctions (id INT AUTO_INCREMENT PRIMARY KEY, seller_id INT NOT NULL, item_name VARCHAR(50) NOT NULL, emoji VARCHAR(10) DEFAULT '📦', starting_price INT NOT NULL, current_price INT NOT NULL, highest_bidder_id INT DEFAULT NULL, status ENUM('active','ended','cancelled') DEFAULT 'active', ends_at TIMESTAMP NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (seller_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_buffs (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, type VARCHAR(30) NOT NULL, expires_at TIMESTAMP NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_coupons (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, type VARCHAR(30) NOT NULL, description VARCHAR(50), value INT DEFAULT 0, used BOOLEAN DEFAULT FALSE, expires_at TIMESTAMP NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_checkin_wheel (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, date DATE NOT NULL, prize VARCHAR(20), created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, UNIQUE KEY unique_user_date (user_id, date)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_blackmarket (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(50) NOT NULL, emoji VARCHAR(10) DEFAULT '📦', price INT NOT NULL, description VARCHAR(200), buyer_id INT DEFAULT NULL, expires_at TIMESTAMP NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_cards (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(50) NOT NULL, emoji VARCHAR(10) DEFAULT '🃏', rarity ENUM('common','rare','epic','legendary') DEFAULT 'common', description VARCHAR(100)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_user_cards (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, card_id INT NOT NULL, count INT DEFAULT 1, acquired_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, FOREIGN KEY (card_id) REFERENCES game_cards(id), UNIQUE KEY unique_user_card (user_id, card_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_fish_codex (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, catch_name VARCHAR(50) NOT NULL, first_caught_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_medals (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, code VARCHAR(50) NOT NULL, name VARCHAR(50) NOT NULL, icon VARCHAR(10) DEFAULT '🏅', earned_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, UNIQUE KEY unique_user_medal (user_id, code)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_pet_skills (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, skill_id INT NOT NULL, learned_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, UNIQUE KEY unique_user_skill (user_id, skill_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_treasure_digs (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, spot VARCHAR(20), reward INT DEFAULT 0, dug_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_stamps (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, code VARCHAR(30) NOT NULL, name VARCHAR(30), collected_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, UNIQUE KEY unique_user_stamp (user_id, code)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_daily_stamps (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, date DATE NOT NULL, stamp_name VARCHAR(30) NOT NULL, theme VARCHAR(30), FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, UNIQUE KEY unique_user_date (user_id, date)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_countdowns (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, name VARCHAR(50) NOT NULL, target_date DATE NOT NULL, emoji VARCHAR(10) DEFAULT '📅', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_notes (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, title VARCHAR(50) NOT NULL, content TEXT, color VARCHAR(20) DEFAULT 'default', pinned BOOLEAN DEFAULT FALSE, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_habits (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, name VARCHAR(50) NOT NULL, emoji VARCHAR(10) DEFAULT '✅', frequency VARCHAR(20) DEFAULT 'daily', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_habit_logs (id INT AUTO_INCREMENT PRIMARY KEY, habit_id INT NOT NULL, date DATE NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (habit_id) REFERENCES game_habits(id) ON DELETE CASCADE, UNIQUE KEY unique_habit_date (habit_id, date)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_reading_log (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, book_name VARCHAR(100) NOT NULL, pages INT DEFAULT 0, minutes INT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_exercise_log (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, exercise_type VARCHAR(30) NOT NULL, duration INT DEFAULT 0, calories INT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_mood_tree (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL UNIQUE, level INT DEFAULT 1, growth INT DEFAULT 0, fruits INT DEFAULT 0, total_watered INT DEFAULT 0, last_watered TIMESTAMP NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_time_capsules (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, message TEXT NOT NULL, open_date DATE NOT NULL, opened BOOLEAN DEFAULT FALSE, opened_at TIMESTAMP NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_calendar_events (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, title VARCHAR(50) NOT NULL, event_date DATE NOT NULL, emoji VARCHAR(10) DEFAULT '📌', color VARCHAR(20) DEFAULT '#667eea', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        await connection.query(`CREATE TABLE IF NOT EXISTS game_contest_entries (id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, pet_name VARCHAR(50), score INT DEFAULT 0, entered_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`);
        console.log('Game center V4+V5 tables checked/created.');

        // Seed cards
        try {
            const [cardCnt] = await connection.query('SELECT COUNT(*) AS cnt FROM game_cards');
            if (cardCnt[0].cnt === 0) {
                await connection.query(`INSERT INTO game_cards (id, name, emoji, rarity, description) VALUES
                    (1,'火焰精灵','🔥','common','小小的火焰精灵'),(2,'水滴精灵','💧','common','清澈的水滴精灵'),
                    (3,'风之精灵','💨','common','轻盈的风之精灵'),(4,'土之精灵','🌍','common','坚实的土之精灵'),
                    (5,'星光精灵','⭐','common','闪闪发光的精灵'),(6,'暗影精灵','🌑','common','神秘的暗影精灵'),
                    (7,'雷龙','⚡','rare','威严的雷电之龙'),(8,'冰凤','❄️','rare','优雅的冰之凤凰'),
                    (9,'森林守护者','🌳','rare','古老的森林守护者'),(10,'海洋领主','🌊','rare','深海中的王者'),
                    (11,'暗夜猎手','🗡️','rare','黑暗中的刺客'),(12,'圣光骑士','🛡️','rare','正义的守护骑士'),
                    (13,'时间法师','⏳','epic','操控时间的法师'),(14,'空间行者','🌀','epic','穿越空间的旅者'),
                    (15,'命运编织者','🔮','epic','编织命运的仙人'),(16,'混沌领主','😈','epic','混沌力量的化身'),
                    (17,'创世之龙','🐉','legendary','传说中创造世界的龙'),(18,'永恒凤凰','🦅','legendary','浴火重生的永恒之鸟'),
                    (19,'世界树之灵','🌳','legendary','连接九界的神灵'),(20,'虚空行者','🕳️','legendary','来自虚空的存在')`);
                console.log('Seeded game_cards.');
            }
        } catch(seedErr) { console.error('Card seed error:', seedErr.message); }
